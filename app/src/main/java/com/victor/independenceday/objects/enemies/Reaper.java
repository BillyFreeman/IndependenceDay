 ...
 */
public class Reaper extends AbstractObject {
    ...
    public static final float DISTRIBUTION = .7f;
    public static final float REAPER_SIZE = .15f;

    private int spriteNumber;

    public Reaper(Bitmap bitmap, PointF basePoint, float size, int speed) {
        ...
        setHealthPoints(ObjectConstants.REAPER_HEALTH);
        setSpeed(speed);
